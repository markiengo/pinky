---
name: "source-command-project-intake"
description: "Build or refresh the repo primer from git history, docs, planning state, and installed workflow tooling."
---

# source-command-project-intake

Use this skill when the user asks to run the migrated source command `project_intake`.
...
- inventory installed workflow packs under `.Codex/`, `.codex/`, and `.mcp.json`
- write only to `.Codex/cache/project-intake.md` and `.Codex/cache/project-intake.json`
