---
name: "source-command-personal-auditor"
...
# source-command-personal-auditor

Use this skill when the user asks to run the migrated source command `personal-auditor`.
