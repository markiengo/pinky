...
Those `.claude` and `.codex` folders are workflow infrastructure, not normal project docs.
...
- Ignore `.claude/agents/`, `.claude/commands/`, `.claude/skills/`, `.claude/skills-meta/`, `.codex/commands/`, `.codex/skills/`, and `.codex/scripts/` unless the user explicitly asks to document workflow infrastructure
